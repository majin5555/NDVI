package com.example.ndvi.util.pictureselector.photocropper;
...
public class CropOverlayView extends View {
    ...
    public void crop(CropListener cropListener, boolean needStretch) {
        ...
        //  Bitmap output = Bitmap.createBitmap(bitmap.getWidth() + 1, bitmap.getHeight() + 1, Bitmap.Config.RGB_565);
