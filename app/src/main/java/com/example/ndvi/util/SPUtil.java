...
public class SPUtil {
    ...
    /** debug 环境下不允许修改 sp文件的路径 */
    public static final  boolean isDebug   = false;
    private final static String  spName    = "NDVI@@##$$";//文件名字
    /** 修改以后的sp文件的路径 MyApplication.getContext().getExternalFilesDir(null).getAbsolutePath()=/sdcard/Android/%package_name%/file */
   public static final  String  FILE_PATH   = NDVIApp.getInstance().getExternalFilesDir(null).getAbsolutePath();
    /**
     * 保存数据
     *
     * @param context
    ...
    public static boolean contains(Context context, String keyName) {
        return getSharedPreferences(context, spName).contains(keyName);
    }
